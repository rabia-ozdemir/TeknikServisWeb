...
<body>
    <div class="sidenav">
        <div class="row side_top">
            <div class="col-4 side_top_left">
                <img src="web/images/com.png" alt="news image" class="img-fluid navimg">
            </div>
    ...
    <div class="main" id="home">
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    <h1>En Uygun Fiyatlarla En Kaliteli Yüzlerce Ürün Bir Tıkla Kapınızda</h1>
        ...
        <section class="slide-wrapper" id="about">
            ...
            <img src="web/images/about.jpg" class="img-fluid" alt="">
            <p class="iner mt-5">
        ...
        <div class="wthree_pvtits-services align-w3" id="services">
            <div class="container">
                <div class="wthree_pvt_title text-center">
                    ...
                    <p class="main_p mb-5  text-center mx-auto">Mağazamızdan Almış Olduğunuz Ürünlerde Herhangi 
                        Bir Teknik Problem Oluşursa 2 Sene İçerisinde Herhangi Bir Ücret Ödemeden
                        Tamir ve Bakım İşlemlerini Yapmaktayız.
                    </p>
                    <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="WebForm1.aspx" role="button" style="background-color:Highlight">Arızalı Ürün Takibi</a>
        ...
        <section class="wedo" id="contact">
            ...
            <p class="main_p mb-5  text-center mx-auto">Mağazamız ya da Aldığınız Herhangi Bir Ürüne Dair 
                Sorun Olursa Bize Aşağıdaki Panelden Mesaj Atarak Ulaşabilirsiniz. 
                Size En Kısa Sürede Dönüş Yapılacaktır.</p>
            <div class="contact_grid_right mt-5 mx-auto text-center">
                <form action="#" method="post" runat="server">
                    <div class="row contact_top">
                     ...
                     <asp:TextBox ID="TextBox4" runat="server" placeholder="Mesajınız:" Height="50px" TextMode="MultiLine"></asp:TextBox>
            ...
            <div class="cpy-right text-center">
                ...
                <p>
                    © 2021 Teknik Servis ve Ürün Takibi | Tüm Hakları Saklıdır
